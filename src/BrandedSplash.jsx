...
export default function BrandedSplash({ tagline = "OPERATIONS DASHBOARD" }) {
  ...
  return (
    <div style={{
      minHeight: "100vh", background: C.darkBlue,
      ...
      <div style={{ textAlign: "center" }}>
        <div style={{
          ...
          margin: "0 auto 14px", boxShadow: `0 0 20px ${C.red}44`,
        }}>FTI</div>
        <div style={{
        ...
        <div style={{
          fontSize: 11, fontWeight: 700, color: "#a0aec8",
          letterSpacing: "0.14em", marginBottom: 18,
        }}>{tagline}</div>
        <div style={{
          width: 120, height: 2, background: C.red, margin: "0 auto",
