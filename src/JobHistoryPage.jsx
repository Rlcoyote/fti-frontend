  ...
  return (
    <div style={{ padding: "24px 28px" }}>
      ...
      <div style={{ fontSize: 12, color: C.muted, marginBottom: 20 }}>
        {allJobs.length} total · {filtered.length} shown
      </div>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 16, flexWrap: "wrap", alignItems: "flex-end" }}>
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <input style={inputStyle} value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Work order #, customer, well, location..." />
        </div>
        <div>
      ...
      <div style={{ border: `1px solid ${C.border}`, borderRadius: 6, overflow: "hidden" }}>
        <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch" }}>
          <div style={{ minWidth: 720 }}>
            ...
            {sorted.length === 0 && <div style={{ textAlign: "center", padding: "40px 0", color: C.muted, fontSize: 13 }}>No jobs match your search.</div>}
            {sorted.map((j, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    display: "grid",
                    gridTemplateColumns: "80px 1fr 1fr 120px 100px 90px",
                    padding: "10px 16px",
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: C.muted }}>
                    {j.wells?.length || 0} well{(j.wells?.length || 0) !== 1 ? "s" : ""}
                  </div>
                  <div>
                    <span
                      style={{
