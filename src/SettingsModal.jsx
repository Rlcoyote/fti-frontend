        ...
        {isAdmin && (
          <div style={{ marginTop: 24, paddingTop: 20, borderTop: `1px solid ${C.border}` }}>
            ...
            <div style={{ fontSize: 11, color: C.muted, marginBottom: 16, lineHeight: 1.5 }}>
              The exact wording shown / spoken when capturing SMS consent.
              Updates are versioned — prior consents stay tied to the
              script wording shown at their capture moment. Owner/admin only.
            </div>
            ...
            <div style={{ background: C.steel, border: `1px solid ${C.border}`, borderRadius: 6, padding: 14, marginBottom: 12 }}>
              <div style={{ fontSize: 12, fontWeight: 800, color: C.text, letterSpacing: "0.08em", marginBottom: 6 }}>
                CUSTOMER REP SCRIPT (VERBAL)
              </div>
              ...
              <textarea
                style={{
                  ...
                  fontSize: 12, color: C.text, background: C.cardBg,
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                <Btn onClick={() => saveScript("customer_rep")}
                  disabled={scriptSaving.customer_rep || scripts.customer_rep === scriptOriginal.customer_rep}>
            ...
            <div style={{ background: C.steel, border: `1px solid ${C.border}`, borderRadius: 6, padding: 14, marginBottom: 12 }}>
              <div style={{ fontSize: 12, fontWeight: 800, color: C.text, letterSpacing: "0.08em", marginBottom: 6 }}>
                EMPLOYEE SCRIPT (IN-APP CHECKBOX)
              </div>
              <div style={{ fontSize: 10, color: C.muted, marginBottom: 8 }}>
              ...
              />
              <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                <Btn onClick={() => saveScript("employee")}
                  disabled={scriptSaving.employee || scripts.employee === scriptOriginal.employee}>
