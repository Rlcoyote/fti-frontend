...
//   workOrderId — needed for the tickets-by-job fetch (poll endpoint filters by job)
...
export default function useSignaturePolling(ticketId, workOrderId, status, signedBy, onSignatureArrived) {
  useEffect(() => {
  ...
  }, [ticketId, workOrderId, status, signedBy]);
}
