        ...
        <div style={{ padding: 24 }}>
          {!type ? (
            ...
            <>
              ...
              {savedTicketId ? (
                <CrewSelectionManager ticketId={savedTicketId} ticketIsClosed={false} editable={true} ticketType={type} jobId={jobId} />
              ) : (
                <>
                  <CrewSelectionView
                    crew={crewSelection}
                  ...
                  return (
                    <div style={{ background: C.steel, border: `1px solid ${C.border}`, borderRadius: 6, padding: "10px 14px", marginBottom: 14 }}>
                      ...
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "6px 24px" }}>
                        <div>
                          <div style={{ fontSize: 10, fontWeight: 700, color: C.blue, letterSpacing: "0.06em", marginBottom: 3 }}>
                            RECOMMENDED TIME TO LEAVE YARD
                          </div>
