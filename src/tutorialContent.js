    ...
    lessons: [
      {
        ...
        steps: [
          ...
          "Assigned a task? The assignee's phone gets a text the moment it lands (if they've opted in to SMS). Assigning at midnight? Set TEXT ASSIGNEE AT and the text waits for the time you pick — including a text to yourself as a morning reminder.",
          "The task says what the text machine DID: open it and read the stamp — SENT, scheduled, or NOT texted with the reason (no phone, or no SMS consent yet). Same under every comment: who got texted, who was skipped and why. No guessing.",
          'Closing a task is notes-first: open it, write COMPLETION NOTES — what closed it out — then press MARK DONE. Nothing to say beyond done? Check "Just DONE — no notes needed" and go. The DONE box on the row is the quick path with the same choices.',
          "A completed task keeps its whole story on the card: CREATED when and by who, the DUE date, COMPLETED when and by who — with an ON TIME or LATE call — and the closure note.",
          "Questions or concerns about a task? Open it and COMMENT — the thread lives ON the task, and posting texts the creator, assignee, and everyone who has commented. Flag ⚑ Needs a response and the task wears an orange chip until the OTHER side answers — your own follow-ups don't clear your own question. When the answer lands, the chip flips green: ⚑ ANSWERED, with who and when.",
          "Every task carries its CHANGE LOG — who created it, who assigned it to whom, every edit, completion and reactivation, in plain words with names and dates. Open the task and expand CHANGE LOG at the bottom.",
          "Got a task text on your phone? Just REPLY to it — no login, no app hunt. Your reply lands in the task's thread automatically, marked BY TEXT, and the circle gets notified.",
          ...
          "And the audit comes to you: any morning something is OVERDUE, managers get a 6:30 AM digest text with the standing by person. A clean board sends nothing.",
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        steps: [
          ...
          "Every phone on the People roster wears its SMS standing: SMS ✓ CONFIRMED means the person replied YES to the opt-in text and operational texts (task assignments, comment threads, reminders) actually reach them. AWAITING YES or NO CONSENT means those texts silently skip — get the YES on file.",
