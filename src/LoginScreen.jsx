...
import LoginJsaSignStep from "./LoginJsaSignStep.jsx";
  ...
  return (
    ...
    >
      <div style={{ background: C.cardBg, borderRadius: 8, padding: 40, width: 380, maxWidth: "90vw", borderTop: `4px solid ${C.red}` }}>
        ...
        {/* Stage 2a biometric confirm — extracted to LoginBiometricStep (v28.161) */}
        {showAuthenticationStep && (
          <LoginBiometricStep
            error={error}
            linkSentMsg={linkSentMsg}
            loading={loading}
            authFailedShowLinkOption={authFailedShowLinkOption}
            onConfirm={completeAuthentication}
            onRequestLink={requestDeviceLink}
