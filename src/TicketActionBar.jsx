...
function TicketActionBar({
  ticket,
  status,
  isLocked, isFullyLocked, isEditing, sigWiped, signedBy,
  existingJSA, jsaLoaded,
  canApprove,
  showSigPad, showSigOptions,
  handleSave, handleClose, handleCancel, handleApprove,
  onClose,
  setIsEditing, setShowSigPad, setShowSigOptions, setShowJSA,
  setShowVoidConfirm, setShowDupModal, setShowDeleteConfirm,
  onRevise, onDuplicate, onDelete,
}) {
  return (
