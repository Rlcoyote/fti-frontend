      ...
      {isOwnerOrAdmin && (
        <div style={{ borderBottom: `2px solid ${C.border}`, padding: "12px 0", marginBottom: 12 }}>
          <div
            ...
            style={{ padding: "0 4px", cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div style={{ padding: "10px 4px", display: "flex", gap: 10, alignItems: "center" }}>
                <button onClick={saveTemplates} disabled={!templatesDirty || templateSaving}
                  style={{
                    ...
                    border: "none", borderRadius: 4, padding: "6px 16px", fontSize: 11, fontWeight: 800,
                ...
                <tr key={u.id} style={{ borderBottom: `1px solid ${C.border}`, background: isOwner ? "#f0f3f8" : "transparent" }}>
                  ...
                  <td style={{ padding: "8px 6px" }}>
                    {canModify ? (
                      ...
                      <span style={{ fontSize: 10, fontWeight: 700, color: C.muted, textTransform: "uppercase", letterSpacing: "0.06em", padding: "2px 8px", borderRadius: 3, background: roleBg(u.role) }}>
